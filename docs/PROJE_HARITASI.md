...
- **`raw_posts.clean_hash` UNIQUE olduğu için 23505 istisna DEĞİL, normal durumdur** — her repost onu tetikler. Satır satır retry bu yüzden chunk başına ~100 ek istek demekti ve tek başına 60 sn'lik Vercel bütçesini yiyordu. Artık 23505'te tek bir yeniden sorgu ile çakışan hash'ler bulunup kalanlar toplu yazılıyor.
