...
- **`raw_posts.post_date` sadeleştiriliyor** (28 Tem 2026). Tek tarih otoritesi `message_date`. Unique indeks `message_date` üzerine taşındı ve kod artık `post_date` yazmıyor; kolonun kendisi dağıtım doğrulandıktan sonra düşürülecek: `docs/20260728_raw_posts_post_date_sadelestirme.sql` ADIM 2. Not: eski 1543 satırda `post_date` mesajın günü değil İÇE AKTARMA günüydü (12–20 May 2026 penceresi) — kolon baştan güvenilmezdi.
