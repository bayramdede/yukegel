...
> ⏳ **Bayram'ı bekleyen TEK SQL:** deploy SONRASI `20260728_contact_phone_revoke.sql`. (`20260728_kvkk_onay.sql` ve `20260728_auth_events.sql` ✅ çalıştırıldı — 29 Tem 2026.) (bkz. `docs/SPRINT_01.md`)
>
