...
> sanması** oldu (bu hata bir kez gerçekten yaşandı — bkz. #91 ve #31).
>
> Ayrım artık şu:
> - `docs/YAPILACAKLAR.md` → **yalnız BEKLEYEN iş.** Kapanan madde oradan SİLİNİR.
> - bu dosya → **olay kaydı ve gerekçe.** "Bu neden böyle yapıldı", "hangi ölçüm
>   ne dedi", "hangi iddiam yanlış çıktı".
> - `docs/PROJE_HARITASI.md` §9 KURALLAR & TUZAKLAR → **kalıcı dersler.** Bir
>   dersin gelecekte iş görmesi gerekiyorsa yeri burası değil, orasıdır.
>
> ⚠️ Buradaki `⏳` / "DEPLOY BEKLİYOR" / "ÇALIŞTIRILMADI" ibarelerinin hiçbirine
> güvenme — hepsi **yazıldıkları günün** durumudur. Neyin açık olduğunu öğrenmek
