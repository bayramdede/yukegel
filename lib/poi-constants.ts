...
export const POI_ALT_ETIKETLER: Record<string, string[]> = {
  ...
  kantar_resmi:        ['Resmi Tartı', 'Elektronik Baskül', 'CMR', 'Geçiş Belgesi', 'Vezneli', 'Devlet Kurumu'],
  kantar_ozel:         ['Hızlı Tartı', 'Uygun Fiyat', '7/24 Açık', 'Fatura Keser', 'Vezneli', 'Anlaşmalı Nakliyeci'],
...
export const POI_KAT_NORM: Record<string, string> = {
  ...
  kantar_resmi:               'kantar_resmi',
  'kantar resmi':             'kantar_resmi',
  'kantar (resmi)':           'kantar_resmi',
  'resmi kantar':             'kantar_resmi',
  kantar_ozel:                'kantar_ozel',
  'kantar özel':              'kantar_ozel',
  'kantar ozel':              'kantar_ozel',
  'özel kantar':              'kantar_ozel',
  kantar:                     'kantar_ozel',   // eski değer → özel'e map
