...
import SurekliYuklerClient from './SurekliYuklerClient';

export const dynamic = 'force-dynamic';
export const metadata = { title: 'Sürekli Yükler — Yükegel Admin' };

export default async function SurekliYuklerPage() {
      ...
      <nav style={{ background: '#161b22', borderBottom: '1px solid #30363d', position: 'sticky', top: 0, zIndex: 50 }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 16px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <span style={{ color: '#e2e8f0', fontWeight: 600, fontSize: '0.95rem' }}>Sürekli Yükler</span>
          </div>
      ...
      <main style={{ maxWidth: 1280, margin: '0 auto', padding: '32px 16px' }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ color: '#8b949e', fontSize: '0.88rem', margin: 0 }}>
            Her gün otomatik yenilenen ilanlar. Sonlandırabilir, duraklatabilir, bitiş tarihini düzenleyebilirsiniz.
          </p>
        </div>
        <SurekliYuklerClient />
      </main>
