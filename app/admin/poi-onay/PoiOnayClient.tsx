...
async function sablonIndir() {
  ...
  const veri = [
    ['Ad', 'Kategori', 'Şehir', 'İlçe', 'Adres', 'Adres Tarifi', 'Enlem', 'Boylam', 'Telefon', 'Web Sitesi', 'Açıklama', 'Etiketler', 'Acil'],
    ['Örnek Tır Parkı',     'tir_parki',           'İstanbul', 'Sultangazi', 'E-5 Karayolu No:1', 'E-5 üzerinde kırmızı çatılı tesis', 41.015137, 28.97953, '0212 123 45 67', 'www.tirparki.com',   'Güvenlikli tır parkı, 24 saat açık. Duş ve WC mevcut.', 'güvenlik,wc,duş', 'HAYIR'],
    ['Şoför Sofrası',       'esnaf_lokantasi',     'Ankara',   'Sincan',     'Sincan OSB Girişi',  '',                                  39.9334,  32.8597,  '0312 456 78 90', '',                   'Günlük tabldot, TIR şoförlerine indirim.', 'tabldot,ucuz', 'HAYIR'],
    ['Akpet Akaryakıt',     'akaryakit_istasyonu', 'İzmir',    'Torbalı',    '',                   '',                                  38.1545,  27.3589,  '',               'www.akpet.com.tr',   '', 'akaryakıt,oto yıkama', 'HAYIR'],
  ];
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(veri), 'POI Listesi');
  const rehber = [
    ['Sütun', 'Zorunlu', 'Açıklama / Örnek'],
    ['Ad',          'Evet', 'Yer adı — ör: Şoför Sofrası'],
    ['Kategori',    'Evet', 'Aşağıdaki listeden kategori kodu seçin'],
    ['Şehir',       'Hayır', 'İl adı — ör: İstanbul'],
    ['İlçe',        'Hayır', 'İlçe adı — ör: Sultangazi'],
    ['Adres',       'Hayır', 'Sokak / cadde / mevki'],
    ['Adres Tarifi','Hayır', 'Sürücüye yol tarifi — ör: "E-5 üzerinde kırmızı çatılı bina"'],
    ['Enlem',       'Evet', 'Ondalık derece — ör: 41.015137'],
    ['Boylam',      'Evet', 'Ondalık derece — ör: 28.979530'],
    ['Telefon',     'Hayır', 'Ör: 0212 123 45 67'],
    ['Web Sitesi',  'Hayır', 'Ör: www.example.com (https:// opsiyonel)'],
    ['Açıklama',    'Hayır', 'Kısa tanıtım notu — max 500 karakter'],
    ['Etiketler',   'Hayır', 'Virgülle ayrılmış özellik etiketleri — ör: wc,duş,güvenlik'],
    ['Acil',        'Hayır', '"EVET" veya "HAYIR" (boş bırakılırsa HAYIR sayılır)'],
    [],
    ['Kategori Kodları', 'Ana Kategori', 'Görünen Ad'],
    ['akaryakit_istasyonu', 'Akaryakıt & Enerji', '⛽ Akaryakıt İstasyonu'],
    ['elektrik_sarj',       'Akaryakıt & Enerji', '🔋 Elektrik Şarj Noktası'],
    ['tir_parki',           'Park & Konaklama',   '🅿️ TIR Parkı'],
    ['otel_pansiyon',       'Park & Konaklama',   '🛏️ Otel & Pansiyon'],
    ['motor_mekanik',       'Tamir & Bakım',      '🔧 Motor & Mekanik'],
    ['lastikci',            'Tamir & Bakım',      '🔄 Lastikçi'],
    ['elektrik_takograf',   'Tamir & Bakım',      '⚡ Elektrik & Takograf'],
    ['branda_dorse',        'Tamir & Bakım',      '🚛 Branda & Dorse'],
    ...
    ['antrepo_depo',        'Operasyon Noktaları', '🏗️ Antrepo & Depo'],
  ];
