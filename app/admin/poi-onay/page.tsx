...
import PoiOnayClient from './PoiOnayClient';

export const dynamic = 'force-dynamic';

export default async function PoiOnayPage() {
      ...
      <main style={{ maxWidth: 1024, margin: '0 auto', padding: '32px 16px' }}>
        <div style={{ marginBottom: 28 }}>
          <h1 style={{ color: '#e2e8f0', fontWeight: 800, fontSize: '1.6rem', margin: 0, marginBottom: 6 }}>
            🗺️ Yol Rehberi — POI Onay
          </h1>
          <div style={{ color: '#8b949e', fontSize: '0.9rem' }}>
            Kullanıcıların eklediği konumları incele, onayla veya reddet.
          </div>
        </div>
        <PoiOnayClient />
      </main>
