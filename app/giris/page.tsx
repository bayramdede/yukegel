    ...
    <div style={{
      ...
      <div style={{width:'100%', maxWidth:400, padding:'0 16px'}}>
        ...
        <div style={{textAlign:'center', marginBottom:32}}>
          ...
          <div style={{color:'#8b949e', fontSize:'0.85rem', marginTop:4}}>Moderatör Girişi</div>
        </div>
        ...
        <div style={{background:'#161b22', border:'1px solid #30363d', borderRadius:12, padding:24}}>
          <form onSubmit={handleGiris}>
            <div style={{marginBottom:16}}>
              <label style={{color:'#8b949e', fontSize:'0.78rem', fontWeight:600,
              ...
              <input
                ...
                style={{width:'100%', background:'#0d1117', color:'#e2e8f0',
                  border:'1px solid #30363d', borderRadius:6, padding:'10px 12px',
